...
def analyze_args(args):
    ...
    if args.draft_model:
        if (getattr(args, 'speculative_decoding', None) != 'dflash'
                and args.draft_device != "NPU" and args.device != "NPU"
    ...
    model_args['speculative_decoding'] = getattr(args, 'speculative_decoding', None)
